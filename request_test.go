...
func TestUnmarshalParsesISO8601WithLocalTimezone(t *testing.T) {
	payload := &OnePayload{
		Data: &Node{
			Type: "timestamps",
			Attributes: map[string]interface{}{
				"timestamp": "2016-08-17T08:27:12+02:00",
			},
		},
	}
	...
	expected := time.Date(2016, 8, 17, 8, 27, 12, 0, time.FixedZone("CEST", 7200))
...
func TestUnmarshalParsesISO8601TimePointerWithLocalTimezone(t *testing.T) {
	payload := &OnePayload{
		Data: &Node{
			Type: "timestamps",
			Attributes: map[string]interface{}{
				"next": "2016-08-17T08:27:12+02:00",
			},
		},
	}
